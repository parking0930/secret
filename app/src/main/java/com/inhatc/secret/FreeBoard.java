...
public class FreeBoard extends AsyncTask<String, Integer, Object> {
    ...
    protected Object doInBackground(String... strings) {
        ...
        HttpClient.Builder http = new HttpClient.Builder("POST", "http://" + ip + ":" + port + "/secret/freeboard_view_50");
