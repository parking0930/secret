...
public class GetSchool extends AsyncTask<Map<String, String>, Integer, String> {
    ...
    protected String doInBackground(Map<String, String>... maps) {
        ...
        HttpClient.Builder http = new HttpClient.Builder("POST", "http://" + ip + ":" + port + "/secret/getSchool");
